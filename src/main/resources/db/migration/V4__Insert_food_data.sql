...
VALUES ('Limão', 'Limão fresco, rico em vitamina C', 'FRUITS', 29, 9.3, 1.1, 0.3, 2.8, 2.5, 60, '1 unidade média',' TACO', true, '100g = 1.7 limões médios'), -- açúcar ligeiramente maior (≈2.5g)
       ...
       ('Coco', 'Polpa de coco fresco', 'FRUITS', 354, 15.2, 3.3, 33.5, 9.0, 6.2, 30, '2 colheres de sopa', 'TACO', true, NULL),
       ('Maracujá', 'Polpa de maracujá azedo', 'FRUITS', 68, 23.4, 2.2, 0.7, 10.4, 11.2, 100, '1/2 xícara de polpa',' TACO', true, '100g = 3-4 maracujás (polpa)'),
       ('Caju', 'Fruto do caju (pedúnculo)', 'FRUITS', 43, 10.3, 0.8, 0.2, 1.7, 8.0, 100, '1 unidade', 'TACO', true, '100g = 1 caju médio'),
       ('Castanha de Caju', 'Castanha de caju torrada', 'NUTS_SEEDS', 570, 18.5, 15.3, 46.3, 3.7, 5.9, 30, '1 punhado', 'TACO', true, '100g = 50-60 castanhas'),
       ('Pera', 'Pera fresca, rica em fibras', 'FRUITS', 57, 15.2, 0.4, 0.1, 3.1, 12.0, 150, '1 unidade média', 'TACO',
        true, '100g = 0.7 pera média'),
       ('Açaí', 'Polpa de açaí pura', 'FRUITS', 80, 6.2, 1.0, 5.9, 2.6, 1.5, 100, '1/2 xícara', 'TACO', true, NULL),
       ...
       ('Buriti', 'Polpa de buriti', 'FRUITS', 270, 19.0, 2.3, 24.0, 20.0, 12.0, 100, '2 colheres de sopa', 'TACO', true, NULL),
       ...
       ('Banana', 'Banana prata madura', 'FRUITS', 89, 22.8, 1.1, 0.3, 2.6, 12.2, 100, '1 unidade média', 'TACO', true, '100g = 1 banana média'),
...
VALUES ('Espinafre', 'Espinafre cru fresco', 'VEGETABLES', 23, 3.6, 2.9, 0.4, 2.2, 1.4, 79, 100, '2 xícaras', 'TACO',
       ...
       ('Cenoura', 'Cenoura crua', 'VEGETABLES', 35, 8.2, 0.8, 0.2, 2.9, 3.5, 69, 100, '1 unidade média', 'TACO', true, '100g = 1 cenoura média'),
       ...
       ('Abóbora', 'Abóbora moranga cozida', 'VEGETABLES', 20, 4.9, 0.7, 0.1, 1.1, 2.0, 1, 100, '1/2 xícara', 'TACO', true, NULL),
       ...
       ('Tomate', 'Tomate salada maduro', 'VEGETABLES', 21, 4.7, 0.9, 0.2, 1.2, 3.2, 5, 120, '1 unidade média', 'TACO', true, '100g = 0.8 tomate médio'),
       ('Cebola', 'Cebola branca crua', 'VEGETABLES', 40, 9.3, 1.1, 0.1, 1.7, 4.2, 4, 100, '1 unidade média', 'TACO',
        true, '100g = 0.8 cebola média'),
       ('Alho', 'Alho cru descascado', 'VEGETABLES', 149, 33.1, 6.4, 0.5, 2.1, 1.0, 17, 3, '1 dente', 'USDA', true, '100g = 25-30 dentes'),
...
INSERT INTO foods (name, description, category, calories_per_100g, carbs_per_100g, protein_per_100g, fat_per_100g,
                   fiber_per_100g, sugar_per_100g, sodium_per_100g, serving_size, serving_description, source, verified, quantity_equivalence)
VALUES ('Frango Peito', 'Peito de frango sem pele, grelhado', 'PROTEINS', 165, 0, 31.0, 3.6, 0, 0, 74, 100, '1 filé médio', 'USDA', true, NULL),
       ('Peixe Branco', 'Filé de peixe branco grelhado', 'PROTEINS', 105, 0, 22.0, 1.5, 0, 0, 70, 150, '1 posta média', 'TACO', true, NULL),
       ('Frango Coxa', 'Coxa de frango sem pele, assada', 'PROTEINS', 184, 0, 24.0, 8.1, 0, 0, 95, 100, '1 coxa média', 'USDA', true, NULL),
       ('Frango Sobrecoxa', 'Sobrecoxa sem pele, grelhada', 'PROTEINS', 165, 0, 25.9, 6.2, 0, 0, 90, 120, '1 sobrecoxa',' USDA', true, NULL),
       ...
       ('Salmão', 'Salmão atlântico grelhado', 'PROTEINS', 208, 0, 22.1, 13.0, 0, 0, 59, 150, '1 filé médio', 'USDA', true, NULL),
       ...
       ('Filé Mignon', 'Filé mignon grelhado', 'PROTEINS', 179, 0, 26.8, 7.0, 0, 0, 54, 100, '1 bife pequeno', 'TACO',
        true, NULL),
       ('Picanha', 'Picanha bovina grelhada', 'PROTEINS', 255, 0, 26.4, 17.0, 0, 0, 62, 100, '1 fatia média', 'USDA', true, NULL),
       ('Lombo Suíno', 'Lombo de porco assado', 'PROTEINS', 242, 0, 27.3, 14.0, 0, 0, 62, 100, '1 fatia média', 'USDA', true, NULL),
       ('Camarão', 'Camarão rosa cozido', 'PROTEINS', 99, 0.9, 20.3, 1.4, 0, 0.1, 566, 100, '8-10 unidades grandes', 'TACO', true, '100g = 8-10 camarões grandes'),
       ('Ovo Cozido', 'Ovo inteiro cozido', 'PROTEINS', 140, 1, 12, 10, 0, 0.4, 124, 50, '1 unidade', 'TACO', true, '100g = 2 ovos médios'),
       ...
       ('Ovo Mexido', 'Ovo inteiro mexido sem óleo', 'PROTEINS', 140, 1, 12, 10, 0, 0.4, 124, 50, '1 ovo médio', 'TACO', true, '100g = 2 ovos médios');
...
INSERT INTO foods (name, description, category, calories_per_100g, carbs_per_100g, protein_per_100g, fat_per_100g,
                   fiber_per_100g, sugar_per_100g, sodium_per_100g, serving_size, serving_description, source, verified, quantity_equivalence)
VALUES ('Arroz Branco', 'Arroz branco polido cozido', 'CEREALS_GRAINS', 128, 28.1, 2.5, 0.1, 0.2, 0.1, 1, 150, '1 xícara', 'TACO', true, NULL),
       ('Arroz Integral', 'Arroz integral cozido', 'CEREALS_GRAINS', 124, 23.0, 2.6, 1.0, 1.8, 0.4, 5, 150, '1 xícara', 'TACO', true, NULL),
       ('Quinoa', 'Quinoa cozida', 'CEREALS_GRAINS', 120, 21.3, 4.4, 1.9, 2.8, 0.9, 7, 100, '1/2 xícara', 'USDA', true, NULL),
       ('Macarrão Integral', 'Macarrão de trigo integral', 'CEREALS_GRAINS', 124, 23.2, 5.3, 1.1, 3.9, 0.8, 3, 100, '1 xícara cozida', 'TACO', true, NULL),
       ('Macarrão Comum', 'Macarrão de trigo comum', 'CEREALS_GRAINS', 131, 25.4, 4.7, 0.9, 1.4, 0.6, 1, 100, '1 xícara cozida', 'TACO', true, NULL),
       ('Pão Francês', 'Pão francês tradicional', 'CEREALS_GRAINS', 300, 58.6, 9.4, 3.1, 2.3, 1.0, 642, 50, '1 unidade', 'TACO', true, '100g = 2 pães franceses'),
       ('Pão Integral', 'Pão de forma integral', 'CEREALS_GRAINS', 63, 10.8, 2.75, 1.0, 1.5, 0, 400, 25, '1 fatia', 'TACO', true, '100g = 4 fatias'),
       ('Batata Inglesa', 'Batata inglesa cozida', 'CEREALS_GRAINS', 87, 20.1, 1.9, 0.1, 1.3, 0.8, 6, 150, '1 unidade média', 'TACO', true, '100g = 0.7 batata média'),
       ('Batata Doce', 'Batata doce assada', 'CEREALS_GRAINS', 118, 28.2, 2.0, 0.1, 3.0, 5.4, 7, 150, '1 unidade média',' TACO', true, '100g = 0.7 batata doce média'),
       ('Mandioca', 'Mandioca cozida', 'CEREALS_GRAINS', 125, 30.1, 1.2, 0.3, 1.6, 1.7, 14, 100, '1 pedaço médio',' TACO', true, NULL),
       ('Aveia', 'Aveia em flocos', 'CEREALS_GRAINS', 394, 66.3, 13.9, 8.5, 9.1, 0.7, 2, 30, '3 colheres sopa', 'TACO',true, NULL),
       ('Tapioca', 'Tapioca granulada', 'CEREALS_GRAINS', 358, 88.7, 0.6, 0.3, 0.2, 0.1, 1, 50, '1 crepe pequeno',' TACO', true, NULL);
...
VALUES ('Castanha do Pará', 'Castanha do Pará crua', 'NUTS_SEEDS', 656, 12.3, 14.3, 63.5, 7.5, 2.3, 3, 15, '3 unidades',
       ...
       ('Amêndoa', 'Amêndoa crua', 'NUTS_SEEDS', 579, 21.6, 21.2, 49.9, 12.5, 4.9, 1, 25, '1 punhado (25g)', 'USDA', true, '100g = 80-85 amêndoas'),
