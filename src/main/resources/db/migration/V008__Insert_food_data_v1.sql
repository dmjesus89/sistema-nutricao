...
VALUES ('Limão', 'Limão fresco, rico em vitamina C', 'FRUITS', 29, 9.3, 1.1, 0.3, 2.8, 1.5, 60, '1 unidade média',
       ...
       ('Açaí', 'Polpa de açaí pura', 'FRUITS', 58, 6.2, 0.8, 3.9, 2.6, 1.5, 100, '1/2 xícara', 'TACO', true, NULL),
       ...
       ('Buriti', 'Polpa de buriti (muito calórica)', 'FRUITS', 308, 19.0, 3.3, 27.2, 25.1, 12.0, 100, '2 colheres sopa', 'TACO', true, NULL),
