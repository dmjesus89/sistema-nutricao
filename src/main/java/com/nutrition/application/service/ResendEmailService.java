...
public class ResendEmailService {
    ...
    private boolean sendEmailViaResend(String to, String subject, String htmlContent) {
        try {
            ...
            if (!response.getStatusCode().is2xxSuccessful()) {
                log.error("Failed to send email via Resend: {}", response.getStatusCode());
                return false;
            }
            ...
            log.error("Error calling Resend API: {}", e.getMessage(), e);
            return false;
        }
    }
    ...
    public CompletableFuture<Void> sendConfirmationEmail(String to, String firstName, String confirmationToken) {
        try {
            ...
            boolean success = sendEmailViaResend(to, subject, htmlContent);
            if (success) {
    ...
    public boolean sendWelcomeEmailSync(String to, String firstName) {
        try {
            ...
            return sendEmailViaResend(to, subject, htmlContent);
        } catch (Exception e) {
    ...
    public CompletableFuture<Void> sendSupplementReminderEmail(String toEmail, String toName, String supplementName,
        ...
        try {
            ...
            boolean success = sendEmailViaResend(toEmail, subject, htmlBody);
            if (success) {
    ...
    public boolean sendSupplementReminderEmailSync(String toEmail, String toName, String supplementName,
        ...
        try {
            ...
            return sendEmailViaResend(toEmail, subject, htmlBody);
        } catch (Exception e) {
